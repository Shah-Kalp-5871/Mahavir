...
<section class="page-hero">
    ...
    <div class="container relative z-10">
        <div class="page-hero-content">
            ...
            <p class="page-hero-sub">Specialised HR solutions designed exclusively for the unique needs of modern businesses across India.</p>
    ...
    <div class="container">
        <div class="split-row">
            ...
            <div class="split-content reveal-right">
                ...
                <h2 class="section-title">People-First <span class="orange">HR Strategy</span> for Your Business</h2>
                <p>In any industry, your team is your greatest competitive advantage. Intelligent HR goes beyond payroll and policies — it's about building a people ecosystem that drives performance, loyalty, and growth.</p>
                <p style="margin-top:1rem;">Our HR specialists understand the specific challenges modern businesses face: seasonal demand, trust-sensitive roles, multi-location management, and a need for specialised expertise. We solve all of this systematically.</p>
...
<section class="section-padding bg-warm">
    <div class="container">
        <div class="section-header centered reveal">
            ...
            <h2 class="section-title">Complete <span class="orange">HR Solutions</span> for Growing Businesses</h2>
        </div>
        <div class="hr-full-grid">
            <div class="sf-card reveal delay-1"><div class="sf-icon"><i class="fas fa-search"></i></div><h3>Talent Acquisition</h3><p>Source, screen, and onboard the right people for sales, operations, and management roles in your business.</p></div>
            ...
            <div class="sf-card reveal delay-3"><div class="sf-icon"><i class="fas fa-file-contract"></i></div><h3>Policy Development</h3><p>Create clear, legally sound HR policies — attendance, conduct, incentives, and dispute resolution — tailored for your needs.</p></div>
            ...
            <div class="sf-card reveal delay-5"><div class="sf-icon"><i class="fas fa-heart"></i></div><h3>Employee Engagement</h3><p>Build a positive workplace culture where your team is motivated, loyal, and brand-proud.</p></div>
...
<section class="section-padding" style="background:#fff;">
    <div class="container"><div class="cta-banner reveal">
        ...
        <p class="section-subtitle">Let our HR specialists help you attract, develop, and retain the talent that powers your business.</p>
